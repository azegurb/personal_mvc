...
(function() {
            ...
            function z(C, D, E) {
                ...
                if (C._.isBlockLike && C.name != 'pre') {
                    var I = C.children.length,
                        ...
                        K;
                    if (J && J.type == 3)
                        if (!(K = e.rtrim(J.value))) C.children.length = I - 1;
                        else J.value = K;
                }
                D.add(C);
                if (C.returnPoint) {
                ...
                switch (t) {
                    case 1:
                        ...
                        if (E.type == 3) {
                            ...
                            if (E)
                                if (!(z = E.getPrevious())) y = E.getParent();
                        } else {
    ...
    (function() {
        function l(u, v) {
            ...
            if (!v) return u;
                ...
                for (var x in v) w.push(x + '=' + encodeURIComponent(v[x]));
        ...
        var p = function() {
            var t = this,
                u = function() {
                    ...
                    if (a._scaytParams)
                        for (var y in a._scaytParams) x[y] = a._scaytParams[y];
        ...
        function o(w) {
            if (this.mode == 'wysiwyg') {
                ...
                for (var H = B.length - 1; H >= 0; H--) {
                    ...
                    var I, J;
                    if (z)
                        while ((I = D.getCommonAncestor(false, true)) && (J = f[I.getName()]) && !(J && J[y])) {
    ...
    (function() {
        ...
        function E(L, M) {
            ...
            if (O)
                for (var Q in O) L.setAttribute(Q, O[Q]);
            ...
            getNextParagraph: function(o) {
                ...
                if (t) {
                    var M = d.walker.bookmark(false, true),
                        N = p.getLast();
                    if (N && N.type == 1 && N.getName() == 'br')
                        if (c || N.getPrevious(M) || N.getNext(M)) N.remove();
                }
    ...
    (function() {
                ...
                if (!ad._.hasFocus) {
                    ...
                    if (ad._.editor.mode == 'wysiwyg' && c) {
                        var aa = K.document.$.selection,
                            ab = aa.createRange();
                        if (ab)
                            if (ab.parentElement && ab.parentElement().ownerDocument == K.document.$ || ab.item && ab.item(0).ownerDocument == K.document.$) {
        ...
        a.dialog.prototype = {
            ...
            foreach: function(K) {
                var N = this;
                for (var L in N._.contents)
                    for (var M in N._.contents[L]) K(N._.contents[L][M]);
                return N;
            },
            reset: (function() {
                var K = function(L) {
