...
//		$this->add[0]=$this->model->getList();
//
//		$this->add['cat']=$this->model->getCategory();
    ...
    public function index(){
        ...
        if(App::getRouter()->getAction()=='index' && App::getRouter()->getParams()[0]==''){

            $this->data['pages'][0]=$this->model->getContent(1);
        }
        else {

            $this->data['pages'][0]=$this->model->getContent(App::getRouter()->getParams()[0]);
